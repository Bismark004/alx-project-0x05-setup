...
const CounterApp: React.FC = () => { 
    ...
    return (
        <div className='min-h-screen bg-gradient-to-r from-yellow-400
         to-pink-500 flex flex-col justify-center items-center text-white'>
            ...
            <p className='text-lg font-medium mb-4'>
              Current count: {count}. {count === 0 ? 
                "🙈 No clicks yet!" : count % 10 === 0 && count !== 0 ? "🔥 You're on fire!" : ""}
            </p>
            ...
            {/*Buttons*/}
             <div className='flex space-x-4'>
                <button
                  ...
                  py-3 px-8 rounded-full text-lg transition duration-300 shadow-lg transform hover:scale-105'
